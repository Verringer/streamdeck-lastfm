...
- Consolidated polling, API, image, and property-inspector logic.
- Replaced the legacy release toolchain with a maintained GitHub Actions workflow.

### Fixed

- Persist default action settings when an action is configured for the first time.
- Stop background polling when an action disappears.
- Handle failed API and image requests without leaving unhandled errors.
