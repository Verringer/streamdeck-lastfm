...
export const initTopTrackPi = (pi: PropertyInspector, pluginContext: string, settings: unknown) => {
  piService.createPropertyInspector(pi, pluginContext, settings, createTopActionConfig(TITLE_DISPLAY_OPTIONS.topTrack));
};