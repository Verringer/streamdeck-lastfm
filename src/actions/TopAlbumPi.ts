...
export const initTopAlbumPi = (pi: PropertyInspector, pluginContext: string, settings: unknown) => {
  piService.createPropertyInspector(pi, pluginContext, settings, createTopActionConfig(TITLE_DISPLAY_OPTIONS.topAlbum));
};